...
IL_003a:
	{
		...
		NullCheck(L_14);
		int32_t L_15;
		L_15 = VirtualFuncInvoker0< int32_t >::Invoke(21, L_14);
		if (L_15)
		{
			goto IL_0054;
		}
...
IL_0054:
	{
		...
		NullCheck(L_20);
		RuntimeObject* L_21;
		L_21 = VirtualFuncInvoker1< RuntimeObject*, int32_t >::Invoke(25, L_20, 0);
...
IL_0031:
	{
		...
		NullCheck(L_8);
		VirtualActionInvoker2< RuntimeArray*, int32_t >::Invoke(32, L_8, L_9, L_10);
		return;
	}
}
